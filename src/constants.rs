...
/// Represents network configuration details.
pub struct Network {
	pub title: &'static str,
	pub scan_url: &'static str,
	pub subgraph_url: &'static str,
	pub subgraph_url_api_key: &'static str,
	pub hmt_address: &'static str,
	pub factory_address: &'static str,
	pub staking_address: &'static str,
	pub kvstore_address: &'static str,
	pub old_subgraph_url: &'static str,
	pub old_factory_address: &'static str,
}

lazy_static! {
	/// Represents a static HashMap of ChainId to Network.
	pub static ref NETWORKS: std::collections::HashMap<ChainId, Network> = map![
		ChainId::Mainnet => Network {
			title: "Ethereum",
			scan_url: "https://etherscan.io",
			subgraph_url: "https://api.studio.thegraph.com/query/74256/ethereum/version/latest",
			subgraph_url_api_key: "https://gateway-arbitrum.network.thegraph.com/api/[SUBGRAPH_API_KEY]/deployments/id/Qmc8ikCj9y2uvYGTeELkM9wybPdcD2PgpW4tjJMwnogLrq",
		...
		ChainId::Sepolia => Network {
			title: "Sepolia",
			scan_url: "https://sepolia.etherscan.io",
			subgraph_url: "https://api.studio.thegraph.com/query/74256/sepolia/version/latest",
			subgraph_url_api_key: "https://gateway-arbitrum.network.thegraph.com/api/[SUBGRAPH_API_KEY]/deployments/id/QmfB1oqYCMTKZB2vcYJzQmGGvVS8cMCHohpYbjKFWoFo8z",
		...
		ChainId::BscMainnet => Network {
			title: "Binance Smart Chain",
			scan_url: "https://bscscan.com",
			subgraph_url: "https://api.studio.thegraph.com/query/74256/bsc/version/latest",
			subgraph_url_api_key: "https://gateway-arbitrum.network.thegraph.com/api/[SUBGRAPH_API_KEY]/deployments/id/QmPEaCSuzbVHDrGEWTS7T4N8U7kBMMMfkj4b4ZeqheVuMc",
		...
		ChainId::BscTestnet => Network {
			title: "Binance Smart Chain (Testnet)",
			scan_url: "https://testnet.bscscan.com",
			subgraph_url: "https://api.studio.thegraph.com/query/74256/bsc-testnet/version/latest",
			subgraph_url_api_key: "https://gateway-arbitrum.network.thegraph.com/api/[SUBGRAPH_API_KEY]/deployments/id/Qmbp8jzcYurrKdk1Mg5ycJ8jcxwou3wWsmNcRdAc16aQEt",
		...
		ChainId::Polygon => Network {
			title: "Polygon",
			scan_url: "https://polygonscan.com",
			subgraph_url: "https://api.studio.thegraph.com/query/74256/polygon/version/latest",
			subgraph_url_api_key: "https://gateway-arbitrum.network.thegraph.com/api/[SUBGRAPH_API_KEY]/deployments/id/QmeSoEuFieiKXtqzDY3WUBz5gKFWwYVPP7iaebpBpJyo7Y",
		...
		ChainId::PolygonAmoy => Network {
			title: "Polygon Amoy",
			scan_url: "https://amoy.polygonscan.com",
			subgraph_url: "https://api.studio.thegraph.com/query/74256/amoy/version/latest",
			subgraph_url_api_key: "https://gateway-arbitrum.network.thegraph.com/api/[SUBGRAPH_API_KEY]/deployments/id/QmQUUv8SK2skarDrJpB8LXXqMwjzxg3Z42dx12uEL5Pmeq",
			hmt_address: "0x792abbcC99c01dbDec49c9fa9A828a186Da45C33",
	...
	pub static ref KV_STORE_KEYS: std::collections::HashMap<String, String> = map![
		"category".to_string() => "category".to_string(),
		"fee".to_string() => "fee".to_string(),
		"job_types".to_string() => "job_types".to_string(),
		"operator_name".to_string() => "operator_name".to_string(),
		"public_key".to_string() => "public_key".to_string(),
		"public_key_hash".to_string() => "public_key_hash".to_string(),
		"registration_instructions".to_string() => "registration_instructions".to_string(),
		"registration_needed".to_string() => "registration_needed".to_string(),
		"role".to_string() => "role".to_string(),
		"url".to_string() => "url".to_string(),
		"website".to_string() => "website".to_string(),
		"webhook_url".to_string() => "webhook_url".to_string()
	];
}

pub const CONFIRMATIONS_THRESHOLD: u8 = 1;
pub const DEFAULT_TX_ID: u8 = 1;
